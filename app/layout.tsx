...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Git Atlas', description: 'Visual Git history for Codex', images: ['https://raw.githubusercontent.com/Kurtor/codex-git-atlas/main/public/og.png'] },
  twitter: { card: 'summary_large_image', title: 'Git Atlas', description: 'Visual Git history for Codex', images: ['https://raw.githubusercontent.com/Kurtor/codex-git-atlas/main/public/og.png'] },
};
